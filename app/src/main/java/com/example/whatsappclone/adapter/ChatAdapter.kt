...
import com.example.whatsappclone.databinding.CharUserItemLayoutBinding
...
class ChatAdapter(var context: Context, var list: ArrayList<UserModel>) : RecyclerView.Adapter<ChatAdapter.ChatViewHolder>() {
    ...
    inner class ChatViewHolder(view : View): RecyclerView.ViewHolder(view) {
        var binding: CharUserItemLayoutBinding = CharUserItemLayoutBinding.bind(view)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChatViewHolder {
        return ChatViewHolder(LayoutInflater.from(parent.context)
            .inflate(R.layout.char_user_item_layout, parent, false))
    }
